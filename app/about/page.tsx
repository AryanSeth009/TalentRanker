        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-6">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-5xl font-bold font-syne mb-2 gradient-text">About TalentRanker.ai</h1>
                <div className="text-lg text-primary font-medium mt-1">Revolutionizing Recruitment</div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <Card key={index} className="text-center glass-card shadow-lg border-0 bg-transparent relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold font-syne text-foreground mb-4">Powerful Features</h2>
              <p className="text-lg text-muted-foreground">Everything you need for modern recruitment</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <Card
                  key={index}
                  className="glass-card shadow-lg border-0 bg-transparent relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300"
                >
                  <CardHeader>
          ...
          {/* Benefits Section */}
          <Card className="shadow-lg border-0 glass-card text-foreground">
            <CardHeader className="text-center">
              <CardTitle className="text-3xl text-foreground mb-2">Why Choose TalentRanker.ai?</CardTitle>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground">Simple, powerful, and effective</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center space-y-4">
                ...
                <h3 className="font-bold text-xl text-foreground">Upload Resumes</h3>
                <p className="text-muted-foreground">Upload multiple PDF or DOCX resume files with drag-and-drop simplicity</p>
              </div>
              <div className="text-center space-y-4">
                ...
                <h3 className="font-bold text-xl text-foreground">Add Job Description</h3>
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="font-bold text-xl text-foreground">Get AI Results</h3>
                <p className="text-muted-foreground">Review ranked candidates with detailed analysis and match scores</p>
              </div>
            </div>
          </div>
          ...
          {/* <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground">Trusted by HR professionals worldwide</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {testimonials.map((testimonial, index) => (
                <Card key={index} className="glass-card shadow-lg border-0 bg-transparent relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
                  <CardContent className="pt-6">
          ...
          {/* CTA Section */}
          <Card className="shadow-lg border-0 bg-gradient-to-r from-blue-600 to-green-600 text-primary-foreground text-center">
            <CardContent className="pt-8 pb-8 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button size="lg" className="bg-card text-primary hover:bg-muted/50 text-foreground px-8 py-3 text-lg font-semibold">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-primary-foreground hover:bg-card hover:text-primary px-8 py-3 text-lg"
                >
                  Schedule Demo
                </Button>
              </div>
